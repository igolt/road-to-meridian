...
const ptBR: Dictionary = {
  ...
  'investor.futureLoans.list.constructor2': 'Construtora:',
  'investor.futureLoans.list.token2': 'Token:',
  'investor.futureLoans.list.location2': 'Localização:',
  'investor.futureLoans.list.term2': 'Prazo:',
  'investor.futureLoans.list.noteToken2': 'Note Token:',
  'investor.futureLoans.list.companyWallet2': '🏢 Carteira da Empresa:',
  'investor.futureLoans.selectPrompt2': 'Selecione um empréstimo para investir',
